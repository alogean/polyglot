#!/usr/bin/ruby
  ...
  # find_duplicates.rb
  # See http://codeidol.com/other/rubyckbk/System-Administration/Finding-Duplicate-Files/
  # Most files of the same size are not duplicates, and it's cheaper to find 
  # this out by reading eight kilobytes than by reading many megabytes and 
  # then performing two MD5 sums. This solution also eliminates any last 
  # possibility that each_set_of_ duplicates will claim two files are
  # duplicates when they're not.
